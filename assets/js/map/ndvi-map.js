...
function initNDVIMap() {
    ...
    const farmIcon = L.divIcon({
        className: '',
        html: '<div style="background:#2D5016;color:#fff;border-radius:50%;width:36px;height:36px;display:flex;align-items:center;justify-content:center;font-size:18px;box-shadow:0 2px 6px rgba(0,0,0,0.4)">🫒</div>',
        iconSize: [36, 36],
        iconAnchor: [18, 18],
    });
    ...
    parcels.forEach(parcel => {
        ...
        const popupHTML = `
            <div style="min-width:200px;font-family:system-ui,sans-serif;font-size:13px">
                ...
                ${parcel.anomaly ? '<div style="background:#f8d7da;color:#721c24;border-radius:4px;padding:3px 7px;font-size:11px;margin-top:4px">⚠️ Anomalia rilevata</div>' : ''}
